...
class BakePage extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      stepTwoInput: 'a',
  ...
  render() {
    return (
      <div className='BakePageWrap'>
        <h1 className='BakePageHeader'>BAKEO'CLOCK IS NOW!</h1>
        <div className='recipeWrap'>
          <ol className='recipe'>
            ...
            <div className='stepTwoInputWrapper'>
              ...
              <label name='stepTwoInput'>Notes:
                <textarea name='stepTwoInput' value={this.state.stepTwoInput} onChange={this.handleChange} />
              </label>
            </div>
            ...
            <label name='stepFourInput'>Notes:
              <textarea name='stepFourInput' value={this.state.stepFourInput} onChange={this.handleChange} />
            </label>
            ...
            <label name='stepFiveInput'>Notes:
              <textarea name='stepFiveInput' value={this.state.stepFiveInput} onChange={this.handleChange} />
            </label>
            ...
            <label name='stepEightInput'>Notes:
              <textarea name='stepEightInput' value={this.state.stepEightInput} onChange={this.handleChange} />
            </label>
            ...
            <label name='stepNineInput'>Notes:
              <textarea name='stepNineInput' value={this.state.stepNineInput} onChange={this.handleChange} />
            </label>
          ...
          <label name='finalNotesInput'>Notes:
            <textarea name='finalNotesInput' value={this.state.finalNotesInput} onChange={this.handleChange} />
          </label>
          <button
          className='bakeFormSubmit'
          onClick={() => {this.props.breadBeenMade(this.state)}}
          >Bread been made</button>
        </div>
